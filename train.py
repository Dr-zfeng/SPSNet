...
parser.add_argument('--epoch_max', '-em', type=int, default=20000) # please stop training mannully 
...
def testing(epo, model, test_loader):
    ...
    label_list = ["unlabeled", "sat", "fanban", "lidar", "penzui"]
    ...
    if epo==0:
        with open(testing_results_file, 'w') as f:
            ...
            f.write("# epoch: unlabeled, sat, fanban, lidar, penzui, average(nan_to_num). (Acc %, IoU %, Pre %, F1 %)\n")
